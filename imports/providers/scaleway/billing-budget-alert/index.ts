// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/billing_budget_alert
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/billing_budget_alert scaleway_billing_budget_alert}
*/
export class BillingBudgetAlert extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BillingBudgetAlert that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/billing_budget_alert#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/billing_budget_alert scaleway_billing_budget_alert} Resource
  *
  * @param scope The scope in which to define this construct
