// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_image
...
export interface DataScalewayInstanceImageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_image#architecture DataScalewayInstanceImage#architecture}
  */
  readonly architecture?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_image#id DataScalewayInstanceImage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_image#image_id DataScalewayInstanceImage#image_id}
  */
  readonly imageId?: string;
  /**
  * Select most recent image if multiple match
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_image#latest DataScalewayInstanceImage#latest}
  */
  readonly latest?: boolean | cdktf.IResolvable;
  /**
  * Exact name of the desired image
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_image#name DataScalewayInstanceImage#name}
  */
  readonly name?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_image#project_id DataScalewayInstanceImage#project_id}
  */
  readonly projectId?: string;
  /**
  * The zone you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_image#zone DataScalewayInstanceImage#zone}
  */
  readonly zone?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_image scaleway_instance_image}
*/
export class DataScalewayInstanceImage extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayInstanceImage that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_image#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_image scaleway_instance_image} Data Source
  *
  * @param scope The scope in which to define this construct
