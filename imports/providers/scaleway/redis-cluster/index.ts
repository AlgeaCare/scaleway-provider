// https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster
...
export interface RedisClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#cluster_size RedisCluster#cluster_size}
  */
  readonly clusterSize?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#id RedisCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#name RedisCluster#name}
  */
  readonly name?: string;
  /**
  * Type of node to use for the cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#node_type RedisCluster#node_type}
  */
  readonly nodeType: string;
  /**
  * Password of the user
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#password RedisCluster#password}
  */
  readonly password: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#project_id RedisCluster#project_id}
  */
  readonly projectId?: string;
  /**
  * Map of settings to define for the cluster.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#settings RedisCluster#settings}
  */
  readonly settings?: { [key: string]: string };
  /**
  * List of tags ["tag1", "tag2", ...] attached to a redis cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#tags RedisCluster#tags}
  */
  readonly tags?: string[];
  /**
  * Whether or not TLS is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#tls_enabled RedisCluster#tls_enabled}
  */
  readonly tlsEnabled?: boolean | cdktf.IResolvable;
  /**
  * Name of the user created when the cluster is created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#user_name RedisCluster#user_name}
  */
  readonly userName: string;
  /**
  * Redis version of the cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#version RedisCluster#version}
  */
  readonly version: string;
  /**
  * The zone you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#zone RedisCluster#zone}
  */
  readonly zone?: string;
  /**
  * acl block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#acl RedisCluster#acl}
  */
  readonly acl?: RedisClusterAcl[] | cdktf.IResolvable;
  /**
  * private_ips block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#private_ips RedisCluster#private_ips}
  */
  readonly privateIps?: RedisClusterPrivateIps[] | cdktf.IResolvable;
  /**
  * private_network block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#private_network RedisCluster#private_network}
  */
  readonly privateNetwork?: RedisClusterPrivateNetwork[] | cdktf.IResolvable;
  /**
  * public_network block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#public_network RedisCluster#public_network}
  */
  readonly publicNetwork?: RedisClusterPublicNetwork;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#timeouts RedisCluster#timeouts}
  */
...
export interface RedisClusterAcl {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#description RedisCluster#description}
  */
  readonly description?: string;
  /**
  * IPv4 network address of the rule (IP network in a CIDR format).
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#ip RedisCluster#ip}
  */
  readonly ip: string;
}
...
export function redisClusterAclToHclTerraform(struct?: RedisClusterAcl | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface RedisClusterPrivateIps {
}

export function redisClusterPrivateIpsToTerraform(struct?: RedisClusterPrivateIps | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function redisClusterPrivateIpsToHclTerraform(struct?: RedisClusterPrivateIps | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class RedisClusterPrivateIpsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): RedisClusterPrivateIps | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: RedisClusterPrivateIps | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
    }
...
export class RedisClusterPrivateIpsList extends cdktf.ComplexList {
  public internalValue? : RedisClusterPrivateIps[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): RedisClusterPrivateIpsOutputReference {
    return new RedisClusterPrivateIpsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface RedisClusterPrivateNetwork {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#service_ips RedisCluster#service_ips}
  */
...
export function redisClusterPrivateNetworkToHclTerraform(struct?: RedisClusterPrivateNetwork | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
  const attrs = {
    ...
    service_ips: {
      value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(struct!.serviceIps),
      isBlock: false,
      type: "list",
...
export interface RedisClusterPublicNetwork {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#ips RedisCluster#ips}
  */
  readonly ips?: string[];
  /**
  * TCP port of the endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#port RedisCluster#port}
  */
...
export function redisClusterPublicNetworkToHclTerraform(struct?: RedisClusterPublicNetworkOutputReference | RedisClusterPublicNetwork): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export interface RedisClusterTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#create RedisCluster#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#default RedisCluster#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#delete RedisCluster#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#update RedisCluster#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster scaleway_redis_cluster}
*/
export class RedisCluster extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RedisCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.60.3/docs/resources/redis_cluster scaleway_redis_cluster} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _privateIps = new RedisClusterPrivateIpsList(this, "private_ips", false);
  public get privateIps() {
    return this._privateIps;
  }
  public putPrivateIps(value: RedisClusterPrivateIps[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      private_ips: cdktf.listMapper(redisClusterPrivateIpsToTerraform, true)(this._privateIps.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      acl: {
        value: cdktf.listMapperHcl(redisClusterAclToHclTerraform, true)(this._acl.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "RedisClusterAclList",
      },
      private_ips: {
        value: cdktf.listMapperHcl(redisClusterPrivateIpsToHclTerraform, true)(this._privateIps.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "RedisClusterPrivateIpsList",
      },
      private_network: {
        value: cdktf.listMapperHcl(redisClusterPrivateNetworkToHclTerraform, true)(this._privateNetwork.internalValue),
        isBlock: true,
        type: "set",
        storageClassType: "RedisClusterPrivateNetworkList",
      },
      public_network: {
        value: redisClusterPublicNetworkToHclTerraform(this._publicNetwork.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "RedisClusterPublicNetworkList",
      },
      timeouts: {
