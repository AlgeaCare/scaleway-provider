// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/annotations_binding
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/annotations_binding scaleway_annotations_binding}
*/
export class AnnotationsBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AnnotationsBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/annotations_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/annotations_binding scaleway_annotations_binding} Resource
  *
  * @param scope The scope in which to define this construct
