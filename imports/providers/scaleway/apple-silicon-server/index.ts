// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server
...
export interface AppleSiliconServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#commitment AppleSiliconServer#commitment}
  */
  readonly commitment?: string;
  /**
  * Whether or not to enable VPC access
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#enable_vpc AppleSiliconServer#enable_vpc}
  */
  readonly enableVpc?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#id AppleSiliconServer#id}
  *
  ...
  * Name of the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#name AppleSiliconServer#name}
  */
  readonly name?: string;
  /**
  * The OS ID of the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#os_id AppleSiliconServer#os_id}
  */
  readonly osId?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#project_id AppleSiliconServer#project_id}
  */
  readonly projectId?: string;
  /**
  * The public bandwidth of the server in bits per second
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#public_bandwidth AppleSiliconServer#public_bandwidth}
  */
  readonly publicBandwidth?: number;
  /**
  * List of runner ids attach to the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#runner_ids AppleSiliconServer#runner_ids}
  */
  readonly runnerIds?: string[];
  /**
  * Type of the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#type AppleSiliconServer#type}
  */
  readonly type: string;
  /**
  * The zone you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#zone AppleSiliconServer#zone}
  */
  readonly zone?: string;
  /**
  * private_ips block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#private_ips AppleSiliconServer#private_ips}
  */
  readonly privateIps?: AppleSiliconServerPrivateIps[] | cdktf.IResolvable;
  /**
  * private_network block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#private_network AppleSiliconServer#private_network}
  */
  readonly privateNetwork?: AppleSiliconServerPrivateNetwork[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#timeouts AppleSiliconServer#timeouts}
  */
  readonly timeouts?: AppleSiliconServerTimeouts;
}
export interface AppleSiliconServerPrivateIps {
}

export function appleSiliconServerPrivateIpsToTerraform(struct?: AppleSiliconServerPrivateIps | cdktf.IResolvable): any {
...
export function appleSiliconServerPrivateIpsToHclTerraform(struct?: AppleSiliconServerPrivateIps | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class AppleSiliconServerPrivateIpsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AppleSiliconServerPrivateIps | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: AppleSiliconServerPrivateIps | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class AppleSiliconServerPrivateIpsList extends cdktf.ComplexList {
  public internalValue? : AppleSiliconServerPrivateIps[] | cdktf.IResolvable
  ...
  */
  public get(index: number): AppleSiliconServerPrivateIpsOutputReference {
    return new AppleSiliconServerPrivateIpsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface AppleSiliconServerPrivateNetwork {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#ipam_ip_ids AppleSiliconServer#ipam_ip_ids}
  */
...
export interface AppleSiliconServerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#create AppleSiliconServer#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#default AppleSiliconServer#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server scaleway_apple_silicon_server}
*/
export class AppleSiliconServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AppleSiliconServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/apple_silicon_server scaleway_apple_silicon_server} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: AppleSiliconServerConfig) {
    ...
    this._runnerIds = config.runnerIds;
  ...
  // runner_ids - computed: true, optional: true, required: false
  private _runnerIds?: string[]; 
  public get runnerIds() {
    return this.getListAttribute('runner_ids');
  }
  public set runnerIds(value: string[]) {
    this._runnerIds = value;
  }
  public resetRunnerIds() {
    this._runnerIds = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get runnerIdsInput() {
    return this._runnerIds;
  }
  ...
  private _privateIps = new AppleSiliconServerPrivateIpsList(this, "private_ips", false);
  public get privateIps() {
    return this._privateIps;
  }
  public putPrivateIps(value: AppleSiliconServerPrivateIps[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      runner_ids: cdktf.listMapper(cdktf.stringToTerraform, false)(this._runnerIds),
      type: cdktf.stringToTerraform(this._type),
      zone: cdktf.stringToTerraform(this._zone),
      private_ips: cdktf.listMapper(appleSiliconServerPrivateIpsToTerraform, true)(this._privateIps.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      public_bandwidth: {
        value: cdktf.numberToHclTerraform(this._publicBandwidth),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      runner_ids: {
        value: cdktf.listMapperHcl(cdktf.stringToHclTerraform, false)(this._runnerIds),
        isBlock: false,
        type: "list",
        storageClassType: "stringList",
      },
      ...
      private_ips: {
        value: cdktf.listMapperHcl(appleSiliconServerPrivateIpsToHclTerraform, true)(this._privateIps.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AppleSiliconServerPrivateIpsList",
      },
      private_network: {
