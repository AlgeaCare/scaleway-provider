// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc_route
...
export interface VpcRouteConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc_route#description VpcRoute#description}
  */
  readonly description?: string;
  /**
  * The destination IP or IP range of the route
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc_route#destination VpcRoute#destination}
  */
  readonly destination?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc_route#id VpcRoute#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc_route#nexthop_private_network_id VpcRoute#nexthop_private_network_id}
  */
  readonly nexthopPrivateNetworkId?: string;
  /**
  * The ID of the nexthop resource
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc_route#nexthop_resource_id VpcRoute#nexthop_resource_id}
  */
  readonly nexthopResourceId?: string;
  /**
  * The ID of the nexthop VPC Connector
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc_route#nexthop_vpc_connector_id VpcRoute#nexthop_vpc_connector_id}
  */
  readonly nexthopVpcConnectorId?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc_route#region VpcRoute#region}
  */
  readonly region?: string;
  /**
  * The tags associated with the Route
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc_route#tags VpcRoute#tags}
  */
  readonly tags?: string[];
  /**
  * VPC ID the Route belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc_route#vpc_id VpcRoute#vpc_id}
  */
  readonly vpcId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc_route scaleway_vpc_route}
*/
export class VpcRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing VpcRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc_route scaleway_vpc_route} Resource
  *
  * @param scope The scope in which to define this construct
