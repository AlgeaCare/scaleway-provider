// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_budget_alert_notification
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_budget_alert_notification scaleway_billing_budget_alert_notification}
*/
export class DataScalewayBillingBudgetAlertNotification extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayBillingBudgetAlertNotification that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_budget_alert_notification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_budget_alert_notification scaleway_billing_budget_alert_notification} Data Source
  *
  * @param scope The scope in which to define this construct
