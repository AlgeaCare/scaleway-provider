// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/redis_cluster
...
export interface DataScalewayRedisClusterConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/redis_cluster#id DataScalewayRedisCluster#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/redis_cluster scaleway_redis_cluster}
*/
export class DataScalewayRedisCluster extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayRedisCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/redis_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/redis_cluster scaleway_redis_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
