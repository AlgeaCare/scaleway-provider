// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/billing_budget
...
export interface BillingBudgetConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/billing_budget#consumption_limit BillingBudget#consumption_limit}
  */
  readonly consumptionLimit: number;
  /**
  * Whether the budget is enabled or not.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/billing_budget#enabled BillingBudget#enabled}
  */
  readonly enabled?: boolean | cdktf.IResolvable;
  /**
  * The organization ID. If not provided, the default organization configured in the provider is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/billing_budget#organization_id BillingBudget#organization_id}
  */
  readonly organizationId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/billing_budget scaleway_billing_budget}
*/
export class BillingBudget extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BillingBudget that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/billing_budget#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/billing_budget scaleway_billing_budget} Resource
  *
  * @param scope The scope in which to define this construct
