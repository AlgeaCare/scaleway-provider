// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment
...
export interface DatawarehouseDeploymentConfig extends cdktf.TerraformMetaArguments {
  ...
  * Maximum CPU count
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#cpu_max DatawarehouseDeployment#cpu_max}
  */
  readonly cpuMax: number;
  /**
  * Minimum CPU count
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#cpu_min DatawarehouseDeployment#cpu_min}
  */
  readonly cpuMin: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#id DatawarehouseDeployment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#name DatawarehouseDeployment#name}
  */
  readonly name: string;
  /**
  * Password for the first user of the deployment. Only one of `password` or `password_wo` should be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#password DatawarehouseDeployment#password}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#password_wo DatawarehouseDeployment#password_wo}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#password_wo_version DatawarehouseDeployment#password_wo_version}
  */
  readonly passwordWoVersion?: number;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#project_id DatawarehouseDeployment#project_id}
  */
  readonly projectId?: string;
  /**
  * RAM per CPU (GB)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#ram_per_cpu DatawarehouseDeployment#ram_per_cpu}
  */
  readonly ramPerCpu: number;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#region DatawarehouseDeployment#region}
  */
  readonly region?: string;
  /**
  * Number of replicas
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#replica_count DatawarehouseDeployment#replica_count}
  */
  readonly replicaCount: number;
  /**
  * Number of shards for the deployment. This value is immutable and cannot be changed after creation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#shard_count DatawarehouseDeployment#shard_count}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#started DatawarehouseDeployment#started}
  */
  readonly started?: boolean | cdktf.IResolvable;
  /**
  * List of tags to apply
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#tags DatawarehouseDeployment#tags}
  */
  readonly tags?: string[];
  /**
  * ClickHouse version to use
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#version DatawarehouseDeployment#version}
  */
  readonly version: string;
  /**
  * private_network block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#private_network DatawarehouseDeployment#private_network}
  */
  readonly privateNetwork?: DatawarehouseDeploymentPrivateNetwork;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#timeouts DatawarehouseDeployment#timeouts}
  */
...
export function datawarehouseDeploymentPrivateNetworkServicesToTerraform(struct?: DatawarehouseDeploymentPrivateNetworkServices): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function datawarehouseDeploymentPrivateNetworkServicesToHclTerraform(struct?: DatawarehouseDeploymentPrivateNetworkServices): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DatawarehouseDeploymentPrivateNetworkServicesOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DatawarehouseDeploymentPrivateNetworkServices | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DatawarehouseDeploymentPrivateNetworkServices | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class DatawarehouseDeploymentPrivateNetworkServicesList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): DatawarehouseDeploymentPrivateNetworkServicesOutputReference {
    return new DatawarehouseDeploymentPrivateNetworkServicesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface DatawarehouseDeploymentPrivateNetwork {
  /**
  * The private network ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#pn_id DatawarehouseDeployment#pn_id}
  */
  readonly pnId: string;
}

export function datawarehouseDeploymentPrivateNetworkToTerraform(struct?: DatawarehouseDeploymentPrivateNetworkOutputReference | DatawarehouseDeploymentPrivateNetwork): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function datawarehouseDeploymentPrivateNetworkToHclTerraform(struct?: DatawarehouseDeploymentPrivateNetworkOutputReference | DatawarehouseDeploymentPrivateNetwork): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DatawarehouseDeploymentPrivateNetworkOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DatawarehouseDeploymentPrivateNetwork | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: DatawarehouseDeploymentPrivateNetwork | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  // services - computed: true, optional: false, required: false
  private _services = new DatawarehouseDeploymentPrivateNetworkServicesList(this, "services", false);
  public get services() {
    return this._services;
  }
}
export interface DatawarehouseDeploymentTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#create DatawarehouseDeployment#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#delete DatawarehouseDeployment#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#read DatawarehouseDeployment#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#update DatawarehouseDeployment#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment scaleway_datawarehouse_deployment}
*/
export class DatawarehouseDeployment extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DatawarehouseDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/datawarehouse_deployment scaleway_datawarehouse_deployment} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _privateNetwork = new DatawarehouseDeploymentPrivateNetworkOutputReference(this, "private_network");
  public get privateNetwork() {
    return this._privateNetwork;
  }
  public putPrivateNetwork(value: DatawarehouseDeploymentPrivateNetwork) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      private_network: {
        value: datawarehouseDeploymentPrivateNetworkToHclTerraform(this._privateNetwork.internalValue),
        isBlock: true,
        type: "list",
