// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server
...
export interface BaremetalServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#cloud_init BaremetalServer#cloud_init}
  */
  readonly cloudInit?: string;
  /**
  * Some description to associate to the server, max 255 characters
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#description BaremetalServer#description}
  */
  readonly description?: string;
  /**
  * Hostname of the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#hostname BaremetalServer#hostname}
  */
  readonly hostname?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#id BaremetalServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#install_config_afterward BaremetalServer#install_config_afterward}
  */
  readonly installConfigAfterward?: boolean | cdktf.IResolvable;
  /**
  * Name of the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#name BaremetalServer#name}
  */
  readonly name?: string;
  /**
  * ID or name of the server offer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#offer BaremetalServer#offer}
  */
  readonly offer: string;
  /**
  * The base image of the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#os BaremetalServer#os}
  */
  readonly os?: string;
  /**
  * The partitioning schema in json format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#partitioning BaremetalServer#partitioning}
  */
  readonly partitioning?: string;
  /**
  * Password used for the installation. Only one of `password` or `password_wo` should be specified.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#password BaremetalServer#password}
  */
  readonly password?: string;
  /**
  * Password used for the installation in [write-only](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs/guides/using-write-only-arguments) mode. Only one of `password` or `password_wo` should be specified. `password_wo` will not be set in the Terraform state. To update the `password_wo`, you must also update the `password_wo_version`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#password_wo BaremetalServer#password_wo}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#password_wo_version BaremetalServer#password_wo_version}
  */
  readonly passwordWoVersion?: number;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#project_id BaremetalServer#project_id}
  */
  readonly projectId?: string;
  /**
  * If true, the baremetal server is protected against accidental deletion via the Scaleway API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#protected BaremetalServer#protected}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#reinstall_on_config_changes BaremetalServer#reinstall_on_config_changes}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#service_password BaremetalServer#service_password}
  */
  readonly servicePassword?: string;
  /**
  * Password used for the service to install in [write-only](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs/guides/using-write-only-arguments) mode. Only one of `service_password` or `service_password_wo` should be specified. `service_password_wo` will not be set in the Terraform state. To update the `service_password_wo`, you must also update the `service_password_wo_version`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#service_password_wo BaremetalServer#service_password_wo}
  */
  readonly servicePasswordWo?: string;
  /**
  * The version of the [write-only](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs/guides/using-write-only-arguments) service password. To update the `service_password_wo`, you must also update the `service_password_wo_version`.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#service_password_wo_version BaremetalServer#service_password_wo_version}
  */
  readonly servicePasswordWoVersion?: number;
  /**
  * User used for the service to install.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#service_user BaremetalServer#service_user}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#ssh_key_ids BaremetalServer#ssh_key_ids}
  */
  readonly sshKeyIds?: string[];
  /**
  * Array of tags to associate with the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#tags BaremetalServer#tags}
  */
  readonly tags?: string[];
  /**
  * User used for the installation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#user BaremetalServer#user}
  */
  readonly user?: string;
  /**
  * The zone you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#zone BaremetalServer#zone}
  */
  readonly zone?: string;
  /**
  * options block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#options BaremetalServer#options}
  */
  readonly options?: BaremetalServerOptions[] | cdktf.IResolvable;
  /**
  * private_ips block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#private_ips BaremetalServer#private_ips}
  */
  readonly privateIps?: BaremetalServerPrivateIps[] | cdktf.IResolvable;
  /**
  * private_network block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#private_network BaremetalServer#private_network}
  */
  readonly privateNetwork?: BaremetalServerPrivateNetwork[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#timeouts BaremetalServer#timeouts}
  */
...
export interface BaremetalServerOptions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#expires_at BaremetalServer#expires_at}
  */
...
export interface BaremetalServerPrivateIps {
}

export function baremetalServerPrivateIpsToTerraform(struct?: BaremetalServerPrivateIps | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function baremetalServerPrivateIpsToHclTerraform(struct?: BaremetalServerPrivateIps | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class BaremetalServerPrivateIpsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): BaremetalServerPrivateIps | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: BaremetalServerPrivateIps | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
    }
...
export class BaremetalServerPrivateIpsList extends cdktf.ComplexList {
  public internalValue? : BaremetalServerPrivateIps[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): BaremetalServerPrivateIpsOutputReference {
    return new BaremetalServerPrivateIpsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface BaremetalServerPrivateNetwork {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#ipam_ip_ids BaremetalServer#ipam_ip_ids}
  */
...
export interface BaremetalServerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#create BaremetalServer#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#default BaremetalServer#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#delete BaremetalServer#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#update BaremetalServer#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server scaleway_baremetal_server}
*/
export class BaremetalServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing BaremetalServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/baremetal_server scaleway_baremetal_server} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: BaremetalServerConfig) {
    ...
    this._os = config.os;
    this._partitioning = config.partitioning;
    ...
    this._servicePasswordWo = config.servicePasswordWo;
    this._servicePasswordWoVersion = config.servicePasswordWoVersion;
  ...
  // service_password_wo - computed: false, optional: true, required: false
  private _servicePasswordWo?: string; 
  public get servicePasswordWo() {
    return this.getStringAttribute('service_password_wo');
  }
  public set servicePasswordWo(value: string) {
    this._servicePasswordWo = value;
  }
  public resetServicePasswordWo() {
    this._servicePasswordWo = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get servicePasswordWoInput() {
    return this._servicePasswordWo;
  }

  // service_password_wo_version - computed: false, optional: true, required: false
  private _servicePasswordWoVersion?: number; 
  public get servicePasswordWoVersion() {
    return this.getNumberAttribute('service_password_wo_version');
  }
  public set servicePasswordWoVersion(value: number) {
    this._servicePasswordWoVersion = value;
  }
  public resetServicePasswordWoVersion() {
    this._servicePasswordWoVersion = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get servicePasswordWoVersionInput() {
    return this._servicePasswordWoVersion;
  }
  ...
  private _privateIps = new BaremetalServerPrivateIpsList(this, "private_ips", false);
  public get privateIps() {
    return this._privateIps;
  }
  public putPrivateIps(value: BaremetalServerPrivateIps[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      partitioning: cdktf.stringToTerraform(this._partitioning),
      ...
      service_password_wo: cdktf.stringToTerraform(this._servicePasswordWo),
      service_password_wo_version: cdktf.numberToTerraform(this._servicePasswordWoVersion),
      ...
      private_ips: cdktf.listMapper(baremetalServerPrivateIpsToTerraform, true)(this._privateIps.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      partitioning: {
        value: cdktf.stringToHclTerraform(this._partitioning),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      service_password_wo: {
        value: cdktf.stringToHclTerraform(this._servicePasswordWo),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      service_password_wo_version: {
        value: cdktf.numberToHclTerraform(this._servicePasswordWoVersion),
        isBlock: false,
        type: "simple",
        storageClassType: "number",
      },
      ...
      private_ips: {
        value: cdktf.listMapperHcl(baremetalServerPrivateIpsToHclTerraform, true)(this._privateIps.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "BaremetalServerPrivateIpsList",
      },
      private_network: {
