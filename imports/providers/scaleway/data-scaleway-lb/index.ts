// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/lb
...
export interface DataScalewayLbConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/lb#id DataScalewayLb#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/lb#lb_id DataScalewayLb#lb_id}
  */
  readonly lbId?: string;
  /**
  * Name of the lb
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/lb#name DataScalewayLb#name}
  */
  readonly name?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/lb#project_id DataScalewayLb#project_id}
  */
  readonly projectId?: string;
  /**
  * Release the IPs related to this load-balancer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/lb#release_ip DataScalewayLb#release_ip}
  */
  readonly releaseIp?: boolean | cdktf.IResolvable;
  /**
  * The zone you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/lb#zone DataScalewayLb#zone}
  */
  readonly zone?: string;
}
export interface DataScalewayLbPrivateIps {
}

export function dataScalewayLbPrivateIpsToTerraform(struct?: DataScalewayLbPrivateIps): any {
...
export function dataScalewayLbPrivateIpsToHclTerraform(struct?: DataScalewayLbPrivateIps): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataScalewayLbPrivateIpsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataScalewayLbPrivateIps | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataScalewayLbPrivateIps | undefined) {
    if (value === undefined) {
...
export class DataScalewayLbPrivateIpsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataScalewayLbPrivateIpsOutputReference {
    return new DataScalewayLbPrivateIpsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/lb scaleway_lb}
*/
export class DataScalewayLb extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayLb that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/lb#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/lb scaleway_lb} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _privateIps = new DataScalewayLbPrivateIpsList(this, "private_ips", false);
