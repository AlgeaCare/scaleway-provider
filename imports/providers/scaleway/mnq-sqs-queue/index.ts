// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue
...
export interface MnqSqsQueueConfig extends cdktf.TerraformMetaArguments {
  ...
  * SQS access key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#access_key MnqSqsQueue#access_key}
  */
  readonly accessKey: string;
  /**
  * Specifies whether to enable content-based deduplication. Allows omitting the deduplication ID
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#content_based_deduplication MnqSqsQueue#content_based_deduplication}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#fifo_queue MnqSqsQueue#fifo_queue}
  */
  readonly fifoQueue?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#id MnqSqsQueue#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#message_max_age MnqSqsQueue#message_max_age}
  */
  readonly messageMaxAge?: number;
  /**
  * The maximum size of a message. Should be in bytes.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#message_max_size MnqSqsQueue#message_max_size}
  */
  readonly messageMaxSize?: number;
  /**
  * The name of the queue. Conflicts with name_prefix.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#name MnqSqsQueue#name}
  */
  readonly name?: string;
  /**
  * Creates a unique name beginning with the specified prefix. Conflicts with name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#name_prefix MnqSqsQueue#name_prefix}
  */
  readonly namePrefix?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#project_id MnqSqsQueue#project_id}
  */
  readonly projectId?: string;
  /**
  * The number of seconds to wait for a message to arrive in the queue before returning.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#receive_wait_time_seconds MnqSqsQueue#receive_wait_time_seconds}
  */
  readonly receiveWaitTimeSeconds?: number;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#region MnqSqsQueue#region}
  */
  readonly region?: string;
  /**
  * SQS secret key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#secret_key MnqSqsQueue#secret_key}
  */
  readonly secretKey: string;
  /**
  * The sqs endpoint
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#sqs_endpoint MnqSqsQueue#sqs_endpoint}
  */
  readonly sqsEndpoint?: string;
  /**
  * The number of seconds a message is hidden from other consumers.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#visibility_timeout_seconds MnqSqsQueue#visibility_timeout_seconds}
  */
  readonly visibilityTimeoutSeconds?: number;
  /**
  * dead_letter_queue block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#dead_letter_queue MnqSqsQueue#dead_letter_queue}
  */
  readonly deadLetterQueue?: MnqSqsQueueDeadLetterQueue;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#timeouts MnqSqsQueue#timeouts}
  */
...
export interface MnqSqsQueueDeadLetterQueue {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#max_receive_count MnqSqsQueue#max_receive_count}
  */
...
export interface MnqSqsQueueTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#create MnqSqsQueue#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#default MnqSqsQueue#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#delete MnqSqsQueue#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#update MnqSqsQueue#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue scaleway_mnq_sqs_queue}
*/
export class MnqSqsQueue extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MnqSqsQueue that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_queue scaleway_mnq_sqs_queue} Resource
  *
  * @param scope The scope in which to define this construct
