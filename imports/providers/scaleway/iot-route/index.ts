// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route
...
export interface IotRouteConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route#id IotRoute#id}
  *
...
export interface IotRouteDatabase {
  ...
  * The database name
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route#dbname IotRoute#dbname}
  */
  readonly dbname: string;
  /**
  * The database hostname
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route#host IotRoute#host}
  */
  readonly host: string;
  /**
  * The database password
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route#password IotRoute#password}
  */
  readonly password: string;
  /**
  * The database port
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route#port IotRoute#port}
  */
  readonly port: number;
  /**
  * SQL query to be executed ($TOPIC and $PAYLOAD variables are available, see documentation)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route#query IotRoute#query}
  */
  readonly query: string;
  /**
  * The database username
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route#username IotRoute#username}
  */
...
export interface IotRouteS3 {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route#bucket_name IotRoute#bucket_name}
  */
  readonly bucketName: string;
  /**
  * The region of the S3 route's destination bucket
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route#bucket_region IotRoute#bucket_region}
  */
  readonly bucketRegion: string;
  /**
  * The string to prefix object names with
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route#object_prefix IotRoute#object_prefix}
  */
  readonly objectPrefix?: string;
  /**
  * How the S3 route's objects will be created: one per topic or one per message
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route#strategy IotRoute#strategy}
  */
...
export interface IotRouteTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route#create IotRoute#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route#default IotRoute#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route scaleway_iot_route}
*/
export class IotRoute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IotRoute that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/iot_route scaleway_iot_route} Resource
  *
  * @param scope The scope in which to define this construct
