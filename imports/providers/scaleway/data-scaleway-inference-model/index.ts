// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/inference_model
...
export interface DataScalewayInferenceModelConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/inference_model#id DataScalewayInferenceModel#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/inference_model scaleway_inference_model}
*/
export class DataScalewayInferenceModel extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayInferenceModel that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/inference_model#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/inference_model scaleway_inference_model} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // secret_wo - computed: true, optional: false, required: false
  public get secretWo() {
    return this.getStringAttribute('secret_wo');
  }

  // secret_wo_version - computed: true, optional: false, required: false
