// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/mnq_sns_credentials
...
export interface MnqSnsCredentialsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/mnq_sns_credentials#id MnqSnsCredentials#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/mnq_sns_credentials#name MnqSnsCredentials#name}
  */
  readonly name?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/mnq_sns_credentials#project_id MnqSnsCredentials#project_id}
  */
  readonly projectId?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/mnq_sns_credentials#region MnqSnsCredentials#region}
  */
  readonly region?: string;
  /**
  * permissions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/mnq_sns_credentials#permissions MnqSnsCredentials#permissions}
  */
...
export interface MnqSnsCredentialsPermissions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/mnq_sns_credentials#can_manage MnqSnsCredentials#can_manage}
  */
  readonly canManage?: boolean | cdktf.IResolvable;
  /**
  * Allow publish messages to the service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/mnq_sns_credentials#can_publish MnqSnsCredentials#can_publish}
  */
  readonly canPublish?: boolean | cdktf.IResolvable;
  /**
  * Allow receive messages from the service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/mnq_sns_credentials#can_receive MnqSnsCredentials#can_receive}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/mnq_sns_credentials scaleway_mnq_sns_credentials}
*/
export class MnqSnsCredentials extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MnqSnsCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/mnq_sns_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/mnq_sns_credentials scaleway_mnq_sns_credentials} Resource
  *
  * @param scope The scope in which to define this construct
