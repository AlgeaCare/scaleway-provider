// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/mongodb_instance
...
export interface DataScalewayMongodbInstanceConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/mongodb_instance#id DataScalewayMongodbInstance#id}
  *
  ...
  * instance id
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/mongodb_instance#instance_id DataScalewayMongodbInstance#instance_id}
  */
  readonly instanceId?: string;
  /**
  * Name of the MongoDB cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/mongodb_instance#name DataScalewayMongodbInstance#name}
  */
  readonly name?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/mongodb_instance#project_id DataScalewayMongodbInstance#project_id}
  */
  readonly projectId?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/mongodb_instance#region DataScalewayMongodbInstance#region}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/mongodb_instance scaleway_mongodb_instance}
*/
export class DataScalewayMongodbInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayMongodbInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/mongodb_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/mongodb_instance scaleway_mongodb_instance} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // is_snapshot_schedule_enabled - computed: true, optional: false, required: false
  ...
  // snapshot_schedule_frequency_hours - computed: true, optional: false, required: false
  public get snapshotScheduleFrequencyHours() {
    return this.getNumberAttribute('snapshot_schedule_frequency_hours');
  }

  // snapshot_schedule_retention_days - computed: true, optional: false, required: false
