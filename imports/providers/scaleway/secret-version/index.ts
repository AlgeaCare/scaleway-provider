// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/secret_version
...
export interface SecretVersionConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/secret_version#data SecretVersion#data}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/secret_version#data_wo SecretVersion#data_wo}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/secret_version#data_wo_version SecretVersion#data_wo_version}
  */
  readonly dataWoVersion?: number;
  /**
  * Description of the secret version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/secret_version#description SecretVersion#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/secret_version#id SecretVersion#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/secret_version#region SecretVersion#region}
  */
  readonly region?: string;
  /**
  * The secret ID associated with this version
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/secret_version#secret_id SecretVersion#secret_id}
  */
  readonly secretId: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/secret_version#timeouts SecretVersion#timeouts}
  */
  readonly timeouts?: SecretVersionTimeouts;
}
export interface SecretVersionTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/secret_version#default SecretVersion#default}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/secret_version scaleway_secret_version}
*/
export class SecretVersion extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/secret_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/secret_version scaleway_secret_version} Resource
  *
  * @param scope The scope in which to define this construct
