// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/baremetal_offer
...
export interface DataScalewayBaremetalOfferConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/baremetal_offer#id DataScalewayBaremetalOffer#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/baremetal_offer scaleway_baremetal_offer}
*/
export class DataScalewayBaremetalOffer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayBaremetalOffer that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/baremetal_offer#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/baremetal_offer scaleway_baremetal_offer} Data Source
  *
  * @param scope The scope in which to define this construct
