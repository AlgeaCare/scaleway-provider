// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/vpc_ingress_rule
...
export interface DataScalewayVpcIngressRuleConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/vpc_ingress_rule#id DataScalewayVpcIngressRule#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/vpc_ingress_rule#ingress_rule_id DataScalewayVpcIngressRule#ingress_rule_id}
  */
  readonly ingressRuleId?: string;
  /**
  * Only ingress rules with the matching IP version will be returned
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/vpc_ingress_rule#is_ipv6 DataScalewayVpcIngressRule#is_ipv6}
  */
  readonly isIpv6?: boolean | cdktf.IResolvable;
  /**
  * The ID of the nexthop private network
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/vpc_ingress_rule#nexthop_private_network_id DataScalewayVpcIngressRule#nexthop_private_network_id}
  */
  readonly nexthopPrivateNetworkId?: string;
  /**
  * IP of the nexthop resource for the ingress rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/vpc_ingress_rule#nexthop_resource_ip DataScalewayVpcIngressRule#nexthop_resource_ip}
  */
  readonly nexthopResourceIp?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/vpc_ingress_rule#region DataScalewayVpcIngressRule#region}
  */
  readonly region?: string;
  /**
  * The tags associated with the ingress rule
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/vpc_ingress_rule#tags DataScalewayVpcIngressRule#tags}
  */
  readonly tags?: string[];
  /**
  * The ID of the VPC the ingress rule belongs to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/vpc_ingress_rule#vpc_id DataScalewayVpcIngressRule#vpc_id}
  */
  readonly vpcId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/vpc_ingress_rule scaleway_vpc_ingress_rule}
*/
export class DataScalewayVpcIngressRule extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayVpcIngressRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/vpc_ingress_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/vpc_ingress_rule scaleway_vpc_ingress_rule} Data Source
  *
  * @param scope The scope in which to define this construct
