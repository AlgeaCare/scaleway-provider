// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_credentials
...
export interface MnqSqsCredentialsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_credentials#id MnqSqsCredentials#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_credentials#name MnqSqsCredentials#name}
  */
  readonly name?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_credentials#project_id MnqSqsCredentials#project_id}
  */
  readonly projectId?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_credentials#region MnqSqsCredentials#region}
  */
  readonly region?: string;
  /**
  * permissions block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_credentials#permissions MnqSqsCredentials#permissions}
  */
...
export interface MnqSqsCredentialsPermissions {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_credentials#can_manage MnqSqsCredentials#can_manage}
  */
  readonly canManage?: boolean | cdktf.IResolvable;
  /**
  * Allow publish messages to the service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_credentials#can_publish MnqSqsCredentials#can_publish}
  */
  readonly canPublish?: boolean | cdktf.IResolvable;
  /**
  * Allow receive messages from the service
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_credentials#can_receive MnqSqsCredentials#can_receive}
  */
  readonly canReceive?: boolean | cdktf.IResolvable;
}

export function mnqSqsCredentialsPermissionsToTerraform(struct?: MnqSqsCredentialsPermissionsOutputReference | MnqSqsCredentialsPermissions): any {
...
export class MnqSqsCredentialsPermissionsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MnqSqsCredentialsPermissions | undefined {
  ...
  public set internalValue(value: MnqSqsCredentialsPermissions | undefined) {
    if (value === undefined) {
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_credentials scaleway_mnq_sqs_credentials}
*/
export class MnqSqsCredentials extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing MnqSqsCredentials that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_credentials#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/mnq_sqs_credentials scaleway_mnq_sqs_credentials} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options MnqSqsCredentialsConfig = {}
  */
  public constructor(scope: Construct, id: string, config: MnqSqsCredentialsConfig = {}) {
    super(scope, id, {
  ...
  private _permissions = new MnqSqsCredentialsPermissionsOutputReference(this, "permissions");
  public get permissions() {
    return this._permissions;
  }
  public putPermissions(value: MnqSqsCredentialsPermissions) {
