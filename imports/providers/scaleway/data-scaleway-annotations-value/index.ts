// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/annotations_value
...
export interface DataScalewayAnnotationsValueConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/annotations_value#value_id DataScalewayAnnotationsValue#value_id}
  */
  readonly valueId: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/annotations_value scaleway_annotations_value}
*/
export class DataScalewayAnnotationsValue extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayAnnotationsValue that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/annotations_value#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/annotations_value scaleway_annotations_value} Data Source
  *
  * @param scope The scope in which to define this construct
