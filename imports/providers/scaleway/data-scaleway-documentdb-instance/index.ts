...
export class DataScalewayDocumentdbInstance extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayDocumentdbInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.34.0/docs/data-sources/documentdb_instance#import import section} in the documentation of this resource for the id to use
