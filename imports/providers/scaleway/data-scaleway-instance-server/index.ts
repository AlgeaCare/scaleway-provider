// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_server
...
export interface DataScalewayInstanceServerConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_server#id DataScalewayInstanceServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_server#name DataScalewayInstanceServer#name}
  */
  readonly name?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_server#project_id DataScalewayInstanceServer#project_id}
  */
  readonly projectId?: string;
  /**
  * The ID of the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_server#server_id DataScalewayInstanceServer#server_id}
  */
  readonly serverId?: string;
  /**
  * The zone you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_server#zone DataScalewayInstanceServer#zone}
  */
  readonly zone?: string;
}
export interface DataScalewayInstanceServerFilesystems {
}

export function dataScalewayInstanceServerFilesystemsToTerraform(struct?: DataScalewayInstanceServerFilesystems): any {
...
export function dataScalewayInstanceServerFilesystemsToHclTerraform(struct?: DataScalewayInstanceServerFilesystems): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataScalewayInstanceServerFilesystemsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataScalewayInstanceServerFilesystems | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataScalewayInstanceServerFilesystems | undefined) {
    if (value === undefined) {
...
export class DataScalewayInstanceServerFilesystemsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataScalewayInstanceServerFilesystemsOutputReference {
    return new DataScalewayInstanceServerFilesystemsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export function dataScalewayInstanceServerPrivateNetworkToHclTerraform(struct?: DataScalewayInstanceServerPrivateNetwork): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataScalewayInstanceServerPublicIpsToHclTerraform(struct?: DataScalewayInstanceServerPublicIps): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function dataScalewayInstanceServerRootVolumeToHclTerraform(struct?: DataScalewayInstanceServerRootVolume): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_server scaleway_instance_server}
*/
export class DataScalewayInstanceServer extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayInstanceServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/instance_server scaleway_instance_server} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _filesystems = new DataScalewayInstanceServerFilesystemsList(this, "filesystems", false);
