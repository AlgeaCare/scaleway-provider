...
export * as documentdbDatabase from './documentdb-database';
export * as documentdbInstance from './documentdb-instance';
export * as documentdbPrivateNetworkEndpoint from './documentdb-private-network-endpoint';
export * as documentdbPrivilege from './documentdb-privilege';
export * as documentdbReadReplica from './documentdb-read-replica';
export * as documentdbUser from './documentdb-user';
...
export * as dataScalewayDocumentdbDatabase from './data-scaleway-documentdb-database';
export * as dataScalewayDocumentdbInstance from './data-scaleway-documentdb-instance';
export * as dataScalewayDocumentdbLoadBalancerEndpoint from './data-scaleway-documentdb-load-balancer-endpoint';
