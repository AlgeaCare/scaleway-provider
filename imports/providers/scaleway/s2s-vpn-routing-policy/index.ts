// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/s2s_vpn_routing_policy
...
export interface S2SVpnRoutingPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/s2s_vpn_routing_policy#id S2SVpnRoutingPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/s2s_vpn_routing_policy#is_ipv6 S2SVpnRoutingPolicy#is_ipv6}
  */
  readonly isIpv6?: boolean | cdktf.IResolvable;
  /**
  * The name of the routing policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/s2s_vpn_routing_policy#name S2SVpnRoutingPolicy#name}
  */
  readonly name?: string;
  /**
  * IP prefixes to accept from the peer (ranges of route announcements to accept)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/s2s_vpn_routing_policy#prefix_filter_in S2SVpnRoutingPolicy#prefix_filter_in}
  */
  readonly prefixFilterIn?: string[];
  /**
  * IP prefix filters to advertise to the peer (ranges of routes to advertise)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/s2s_vpn_routing_policy#prefix_filter_out S2SVpnRoutingPolicy#prefix_filter_out}
  */
  readonly prefixFilterOut?: string[];
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/s2s_vpn_routing_policy#project_id S2SVpnRoutingPolicy#project_id}
  */
  readonly projectId?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/s2s_vpn_routing_policy#region S2SVpnRoutingPolicy#region}
  */
  readonly region?: string;
  /**
  * The list of tags to apply to the routing policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/s2s_vpn_routing_policy#tags S2SVpnRoutingPolicy#tags}
  */
  readonly tags?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/s2s_vpn_routing_policy scaleway_s2s_vpn_routing_policy}
*/
export class S2SVpnRoutingPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing S2SVpnRoutingPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/s2s_vpn_routing_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/s2s_vpn_routing_policy scaleway_s2s_vpn_routing_policy} Resource
  *
  * @param scope The scope in which to define this construct
