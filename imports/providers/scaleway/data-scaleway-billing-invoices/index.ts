// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_invoices
...
export interface DataScalewayBillingInvoicesConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_invoices#id DataScalewayBillingInvoices#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_invoices scaleway_billing_invoices}
*/
export class DataScalewayBillingInvoices extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayBillingInvoices that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_invoices#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_invoices scaleway_billing_invoices} Data Source
  *
  * @param scope The scope in which to define this construct
