// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/key_manager_key
...
export interface DataScalewayKeyManagerKeyConfig extends cdktf.TerraformMetaArguments {
  ...
  * The ID of the key
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/key_manager_key#key_id DataScalewayKeyManagerKey#key_id}
  */
  readonly keyId: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/key_manager_key#region DataScalewayKeyManagerKey#region}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/key_manager_key scaleway_key_manager_key}
*/
export class DataScalewayKeyManagerKey extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayKeyManagerKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/key_manager_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/key_manager_key scaleway_key_manager_key} Data Source
  *
  * @param scope The scope in which to define this construct
