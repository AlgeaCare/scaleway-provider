// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server
...
export interface InstanceServerConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#additional_volume_ids InstanceServer#additional_volume_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#admin_password_encryption_ssh_key_id InstanceServer#admin_password_encryption_ssh_key_id}
  */
  readonly adminPasswordEncryptionSshKeyId?: string;
  /**
  * The boot type of the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#boot_type InstanceServer#boot_type}
  */
  readonly bootType?: string;
  /**
  * ID of the target bootscript (set boot_type to bootscript)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#bootscript_id InstanceServer#bootscript_id}
  */
  readonly bootscriptId?: string;
  /**
  * The cloud init script associated with this server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#cloud_init InstanceServer#cloud_init}
  */
  readonly cloudInit?: string;
  /**
  * Enable dynamic IP on the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#enable_dynamic_ip InstanceServer#enable_dynamic_ip}
  */
  readonly enableDynamicIp?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#id InstanceServer#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#image InstanceServer#image}
  */
  readonly image?: string;
  /**
  * The ID of the reserved IP for the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#ip_id InstanceServer#ip_id}
  */
  readonly ipId?: string;
  /**
  * The IDs of the reserved IP for the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#ip_ids InstanceServer#ip_ids}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#placement_group_id InstanceServer#placement_group_id}
  */
  readonly placementGroupId?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#project_id InstanceServer#project_id}
  */
  readonly projectId?: string;
  /**
  * If true, the instance is protected against accidental deletion via the Scaleway API.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#protected InstanceServer#protected}
  */
  readonly protected?: boolean | cdktf.IResolvable;
  /**
  * Delete and re-create server if type change
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#replace_on_type_change InstanceServer#replace_on_type_change}
  */
  readonly replaceOnTypeChange?: boolean | cdktf.IResolvable;
  /**
  * The security group the server is attached to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#security_group_id InstanceServer#security_group_id}
  */
  readonly securityGroupId?: string;
  /**
  * The state of the server should be: started, stopped, standby
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#state InstanceServer#state}
  */
  readonly state?: string;
  /**
  * The tags associated with the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#tags InstanceServer#tags}
  */
  readonly tags?: string[];
  /**
  * The instance type of the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#type InstanceServer#type}
  */
  readonly type: string;
  /**
  * The user data associated with the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#user_data InstanceServer#user_data}
  */
  ...
  * filesystems block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#filesystems InstanceServer#filesystems}
  */
  readonly filesystems?: InstanceServerFilesystems[] | cdktf.IResolvable;
  /**
  * private_ips block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#private_ips InstanceServer#private_ips}
  */
  readonly privateIps?: InstanceServerPrivateIps[] | cdktf.IResolvable;
  /**
  * private_network block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#private_network InstanceServer#private_network}
  */
  readonly privateNetwork?: InstanceServerPrivateNetwork[] | cdktf.IResolvable;
  /**
  * public_ips block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#public_ips InstanceServer#public_ips}
  */
  readonly publicIps?: InstanceServerPublicIps[] | cdktf.IResolvable;
  /**
  * root_volume block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#root_volume InstanceServer#root_volume}
  */
  readonly rootVolume?: InstanceServerRootVolume;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#timeouts InstanceServer#timeouts}
  */
  readonly timeouts?: InstanceServerTimeouts;
}
export interface InstanceServerFilesystems {
  /**
  * The filesystem ID attached to the server
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#filesystem_id InstanceServer#filesystem_id}
  */
  readonly filesystemId?: string;
}

export function instanceServerFilesystemsToTerraform(struct?: InstanceServerFilesystems | cdktf.IResolvable): any {
...
export function instanceServerFilesystemsToHclTerraform(struct?: InstanceServerFilesystems | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class InstanceServerFilesystemsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): InstanceServerFilesystems | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: InstanceServerFilesystems | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class InstanceServerFilesystemsList extends cdktf.ComplexList {
  public internalValue? : InstanceServerFilesystems[] | cdktf.IResolvable
  ...
  */
  public get(index: number): InstanceServerFilesystemsOutputReference {
    return new InstanceServerFilesystemsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface InstanceServerPrivateIps {
}

export function instanceServerPrivateIpsToTerraform(struct?: InstanceServerPrivateIps | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function instanceServerPrivateIpsToHclTerraform(struct?: InstanceServerPrivateIps | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class InstanceServerPrivateIpsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktf.IResolvable;
  ...
  */
  ...
  public get internalValue(): InstanceServerPrivateIps | cdktf.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: InstanceServerPrivateIps | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
    }
...
export class InstanceServerPrivateIpsList extends cdktf.ComplexList {
  public internalValue? : InstanceServerPrivateIps[] | cdktf.IResolvable
  ...
  * @param index the index of the item to return
  */
  public get(index: number): InstanceServerPrivateIpsOutputReference {
    return new InstanceServerPrivateIpsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class InstanceServerPublicIpsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  // provisioning_mode - computed: true, optional: false, required: false
  public get provisioningMode() {
    return this.getStringAttribute('provisioning_mode');
  }
}
...
export interface InstanceServerTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#create InstanceServer#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#default InstanceServer#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#delete InstanceServer#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#read InstanceServer#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#update InstanceServer#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server scaleway_instance_server}
*/
export class InstanceServer extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InstanceServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/instance_server scaleway_instance_server} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: InstanceServerConfig) {
    ...
    this._adminPasswordEncryptionSshKeyId = config.adminPasswordEncryptionSshKeyId;
  ...
  // admin_password_encryption_ssh_key_id - computed: false, optional: true, required: false
  private _adminPasswordEncryptionSshKeyId?: string; 
  public get adminPasswordEncryptionSshKeyId() {
    return this.getStringAttribute('admin_password_encryption_ssh_key_id');
  }
  public set adminPasswordEncryptionSshKeyId(value: string) {
    this._adminPasswordEncryptionSshKeyId = value;
  }
  public resetAdminPasswordEncryptionSshKeyId() {
    this._adminPasswordEncryptionSshKeyId = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get adminPasswordEncryptionSshKeyIdInput() {
    return this._adminPasswordEncryptionSshKeyId;
  }
  ...
  private _filesystems = new InstanceServerFilesystemsList(this, "filesystems", false);
  public get filesystems() {
    return this._filesystems;
  }
  public putFilesystems(value: InstanceServerFilesystems[] | cdktf.IResolvable) {
  ...
  private _privateIps = new InstanceServerPrivateIpsList(this, "private_ips", false);
  public get privateIps() {
    return this._privateIps;
  }
  public putPrivateIps(value: InstanceServerPrivateIps[] | cdktf.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      admin_password_encryption_ssh_key_id: cdktf.stringToTerraform(this._adminPasswordEncryptionSshKeyId),
      ...
      filesystems: cdktf.listMapper(instanceServerFilesystemsToTerraform, true)(this._filesystems.internalValue),
      private_ips: cdktf.listMapper(instanceServerPrivateIpsToTerraform, true)(this._privateIps.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      admin_password_encryption_ssh_key_id: {
        value: cdktf.stringToHclTerraform(this._adminPasswordEncryptionSshKeyId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      filesystems: {
        value: cdktf.listMapperHcl(instanceServerFilesystemsToHclTerraform, true)(this._filesystems.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "InstanceServerFilesystemsList",
      },
      private_ips: {
        value: cdktf.listMapperHcl(instanceServerPrivateIpsToHclTerraform, true)(this._privateIps.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "InstanceServerPrivateIpsList",
      },
      private_network: {
