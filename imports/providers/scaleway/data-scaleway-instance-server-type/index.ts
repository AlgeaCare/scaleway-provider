// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/instance_server_type
...
export interface DataScalewayInstanceServerTypeConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/instance_server_type#id DataScalewayInstanceServerType#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/instance_server_type scaleway_instance_server_type}
*/
export class DataScalewayInstanceServerType extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayInstanceServerType that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/instance_server_type#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/instance_server_type scaleway_instance_server_type} Data Source
  *
  * @param scope The scope in which to define this construct
