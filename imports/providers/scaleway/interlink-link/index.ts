// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link
...
export interface InterlinkLinkConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#bandwidth_mbps InterlinkLink#bandwidth_mbps}
  */
  readonly bandwidthMbps: number;
  /**
  * If set, creates a self-hosted link using this dedicated physical connection
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#connection_id InterlinkLink#connection_id}
  */
  readonly connectionId?: string;
  /**
  * Defines whether route propagation is enabled or not. Defaults to false
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#enable_route_propagation InterlinkLink#enable_route_propagation}
  */
  readonly enableRoutePropagation?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#id InterlinkLink#id}
  *
  ...
  * Name of the link
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#name InterlinkLink#name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#partner_id InterlinkLink#partner_id}
  */
  readonly partnerId?: string;
  /**
  * For self-hosted links, the peer AS Number to establish BGP session. Required when `connection_id` is set
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#peer_asn InterlinkLink#peer_asn}
  */
  readonly peerAsn?: number;
  /**
  * PoP (location) where the link will be created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#pop_id InterlinkLink#pop_id}
  */
  readonly popId: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#project_id InterlinkLink#project_id}
  */
  readonly projectId?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#region InterlinkLink#region}
  */
  readonly region?: string;
  /**
  * If set, attaches this routing policy containing IPv4 prefixes to the link. A BGP IPv4 session will be created
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#routing_policy_v4_id InterlinkLink#routing_policy_v4_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#routing_policy_v6_id InterlinkLink#routing_policy_v6_id}
  */
  readonly routingPolicyV6Id?: string;
  /**
  * List of tags associated with the link
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#tags InterlinkLink#tags}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#vlan InterlinkLink#vlan}
  */
  readonly vlan?: number;
  /**
  * ID of the Scaleway VPC to attach to the link
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#vpc_id InterlinkLink#vpc_id}
  */
  readonly vpcId?: string;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#timeouts InterlinkLink#timeouts}
  */
...
export interface InterlinkLinkTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#create InterlinkLink#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#default InterlinkLink#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#delete InterlinkLink#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#read InterlinkLink#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#update InterlinkLink#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link scaleway_interlink_link}
*/
export class InterlinkLink extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterlinkLink that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/interlink_link scaleway_interlink_link} Resource
  *
  * @param scope The scope in which to define this construct
