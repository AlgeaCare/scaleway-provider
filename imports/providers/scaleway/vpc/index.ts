// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc
...
export interface VpcConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc#enable_custom_routes_propagation Vpc#enable_custom_routes_propagation}
  */
  readonly enableCustomRoutesPropagation?: boolean | cdktf.IResolvable;
  /**
  * Enable routing between Private Networks in the VPC
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc#enable_routing Vpc#enable_routing}
  */
  readonly enableRouting?: boolean | cdktf.IResolvable;
  /**
  * Enable packets from peered VPCs to transit through this VPC
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc#enable_transitivity Vpc#enable_transitivity}
  */
  readonly enableTransitivity?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc#id Vpc#id}
  *
  ...
  * The name of the VPC
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc#name Vpc#name}
  */
  readonly name?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc#project_id Vpc#project_id}
  */
  readonly projectId?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc#region Vpc#region}
  */
  readonly region?: string;
  /**
  * The tags associated with the VPC
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc#tags Vpc#tags}
  */
  readonly tags?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc scaleway_vpc}
*/
export class Vpc extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Vpc that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/vpc scaleway_vpc} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public set enableCustomRoutesPropagation(value: boolean | cdktf.IResolvable) {
    this._enableCustomRoutesPropagation = value;
  }
  public resetEnableCustomRoutesPropagation() {
    this._enableCustomRoutesPropagation = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get enableCustomRoutesPropagationInput() {
    return this._enableCustomRoutesPropagation;
  }

  // enable_routing - computed: true, optional: true, required: false
  private _enableRouting?: boolean | cdktf.IResolvable; 
  public get enableRouting() {
    return this.getBooleanAttribute('enable_routing');
  }
  public set enableRouting(value: boolean | cdktf.IResolvable) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      enable_custom_routes_propagation: {
        value: cdktf.booleanToHclTerraform(this._enableCustomRoutesPropagation),
        isBlock: false,
        type: "simple",
