// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_budget_alert
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_budget_alert scaleway_billing_budget_alert}
*/
export class DataScalewayBillingBudgetAlert extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayBillingBudgetAlert that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_budget_alert#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_budget_alert scaleway_billing_budget_alert} Data Source
  *
  * @param scope The scope in which to define this construct
