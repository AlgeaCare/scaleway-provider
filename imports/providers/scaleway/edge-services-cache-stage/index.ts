// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage
...
export interface EdgeServicesCacheStageConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage#backend_stage_id EdgeServicesCacheStage#backend_stage_id}
  */
  readonly backendStageId?: string;
  /**
  * The Time To Live (TTL) in seconds. Defines how long content is cached
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage#fallback_ttl EdgeServicesCacheStage#fallback_ttl}
  */
  readonly fallbackTtl?: number;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage#id EdgeServicesCacheStage#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage#include_cookies EdgeServicesCacheStage#include_cookies}
  */
  readonly includeCookies?: boolean | cdktf.IResolvable;
  /**
  * The ID of the pipeline
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage#pipeline_id EdgeServicesCacheStage#pipeline_id}
  */
  readonly pipelineId: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage#project_id EdgeServicesCacheStage#project_id}
  */
  readonly projectId?: string;
  /**
  * Trigger a refresh of the cache by changing this field's value
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage#refresh_cache EdgeServicesCacheStage#refresh_cache}
  */
  readonly refreshCache?: string;
  /**
  * The route stage ID the cache stage will be linked to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage#route_stage_id EdgeServicesCacheStage#route_stage_id}
  */
  readonly routeStageId?: string;
  /**
  * The WAF stage ID the cache stage will be linked to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage#waf_stage_id EdgeServicesCacheStage#waf_stage_id}
  */
  readonly wafStageId?: string;
  /**
  * purge_requests block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage#purge_requests EdgeServicesCacheStage#purge_requests}
  */
...
export interface EdgeServicesCacheStagePurgeRequests {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage#all EdgeServicesCacheStage#all}
  */
  readonly all?: boolean | cdktf.IResolvable;
  /**
  * The list of asserts to purge
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage#assets EdgeServicesCacheStage#assets}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage scaleway_edge_services_cache_stage}
*/
export class EdgeServicesCacheStage extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing EdgeServicesCacheStage that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/edge_services_cache_stage scaleway_edge_services_cache_stage} Resource
  *
  * @param scope The scope in which to define this construct
