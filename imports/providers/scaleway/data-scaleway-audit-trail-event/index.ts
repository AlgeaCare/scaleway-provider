// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event
...
export interface DataScalewayAuditTrailEventConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#id DataScalewayAuditTrailEvent#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#method_name DataScalewayAuditTrailEvent#method_name}
  */
  readonly methodName?: string;
  /**
  * Defines the order in which events are returned. Default value: recorded_at_desc
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#order_by DataScalewayAuditTrailEvent#order_by}
  */
  readonly orderBy?: string;
  /**
  * ID of the organization containing the Audit Trail events.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#organization_id DataScalewayAuditTrailEvent#organization_id}
  */
  readonly organizationId?: string;
  /**
  * ID of the User or IAM application at the origin of the event
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#principal_id DataScalewayAuditTrailEvent#principal_id}
  */
  readonly principalId?: string;
  /**
  * Scaleway product associated with the listed events in a hyphenated format
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#product_name DataScalewayAuditTrailEvent#product_name}
  */
  readonly productName?: string;
  /**
  * ID of the project containing the Audit Trail events.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#project_id DataScalewayAuditTrailEvent#project_id}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#recorded_after DataScalewayAuditTrailEvent#recorded_after}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#recorded_before DataScalewayAuditTrailEvent#recorded_before}
  */
  readonly recordedBefore?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#region DataScalewayAuditTrailEvent#region}
  */
  readonly region?: string;
  /**
  * ID of the Scaleway resource associated with the listed events
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#resource_id DataScalewayAuditTrailEvent#resource_id}
  */
  readonly resourceId?: string;
  /**
  * Type of the scaleway resources associated with the listed events
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#resource_type DataScalewayAuditTrailEvent#resource_type}
  */
  readonly resourceType?: string;
  /**
  * Name of the service of the API call performed
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#service_name DataScalewayAuditTrailEvent#service_name}
  */
  readonly serviceName?: string;
  /**
  * IP address at the origin of the event
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#source_ip DataScalewayAuditTrailEvent#source_ip}
  */
  readonly sourceIp?: string;
  /**
  * HTTP status code of the request
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#status DataScalewayAuditTrailEvent#status}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event scaleway_audit_trail_event}
*/
export class DataScalewayAuditTrailEvent extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayAuditTrailEvent that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/audit_trail_event scaleway_audit_trail_event} Data Source
  *
  * @param scope The scope in which to define this construct
