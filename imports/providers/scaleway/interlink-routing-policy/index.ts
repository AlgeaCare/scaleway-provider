// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/interlink_routing_policy
...
export interface InterlinkRoutingPolicyConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/interlink_routing_policy#id InterlinkRoutingPolicy#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/interlink_routing_policy#is_ipv6 InterlinkRoutingPolicy#is_ipv6}
  */
  readonly isIpv6?: boolean | cdktf.IResolvable;
  /**
  * The name of the routing policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/interlink_routing_policy#name InterlinkRoutingPolicy#name}
  */
  readonly name?: string;
  /**
  * IP prefixes to accept from the peer (ranges of route announcements to accept)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/interlink_routing_policy#prefix_filter_in InterlinkRoutingPolicy#prefix_filter_in}
  */
  readonly prefixFilterIn?: string[];
  /**
  * IP prefix filters to advertise to the peer (ranges of routes to advertise)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/interlink_routing_policy#prefix_filter_out InterlinkRoutingPolicy#prefix_filter_out}
  */
  readonly prefixFilterOut?: string[];
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/interlink_routing_policy#project_id InterlinkRoutingPolicy#project_id}
  */
  readonly projectId?: string;
  /**
  * The region you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/interlink_routing_policy#region InterlinkRoutingPolicy#region}
  */
  readonly region?: string;
  /**
  * The list of tags associated with the routing policy
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/interlink_routing_policy#tags InterlinkRoutingPolicy#tags}
  */
  readonly tags?: string[];
}

/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/interlink_routing_policy scaleway_interlink_routing_policy}
*/
export class InterlinkRoutingPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing InterlinkRoutingPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/interlink_routing_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/interlink_routing_policy scaleway_interlink_routing_policy} Resource
  *
  * @param scope The scope in which to define this construct
