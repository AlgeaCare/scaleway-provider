// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/billing_budget_alert
...
export interface DataScalewayBillingBudgetAlertConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/billing_budget_alert#alert_id DataScalewayBillingBudgetAlert#alert_id}
  */
  readonly alertId: string;
  /**
  * The ID of the budget. If not provided, it will be retrieved from the alert.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/billing_budget_alert#budget_id DataScalewayBillingBudgetAlert#budget_id}
  */
  readonly budgetId?: string;
  /**
  * The organization ID. If not provided, the default organization configured in the provider is used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/billing_budget_alert#organization_id DataScalewayBillingBudgetAlert#organization_id}
  */
  readonly organizationId?: string;
}

/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/billing_budget_alert scaleway_billing_budget_alert}
*/
export class DataScalewayBillingBudgetAlert extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayBillingBudgetAlert that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/billing_budget_alert#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/data-sources/billing_budget_alert scaleway_billing_budget_alert} Data Source
  *
  * @param scope The scope in which to define this construct
