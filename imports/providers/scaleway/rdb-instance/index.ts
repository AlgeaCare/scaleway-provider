// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/rdb_instance
...
export interface RdbInstanceConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/rdb_instance#id RdbInstance#id}
  *
  ...
  */
  ...
  /**
  * Password for the first user of the database instance in [write-only](https://registry.terraform.io/providers/scaleway/scaleway/latest/docs/guides/using-write-only-arguments) mode. Only one of `password` or `password_wo` should be specified. `password_wo` will not be set in the Terraform state. To update the `password_wo`, you must also update the `password_wo_version`.
  *
...
export interface RdbInstanceMaintenances {
}

export function rdbInstanceMaintenancesToTerraform(struct?: RdbInstanceMaintenances): any {
...
export function rdbInstanceMaintenancesToHclTerraform(struct?: RdbInstanceMaintenances): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class RdbInstanceMaintenancesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RdbInstanceMaintenances | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: RdbInstanceMaintenances | undefined) {
    if (value === undefined) {
...
export class RdbInstanceMaintenancesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): RdbInstanceMaintenancesOutputReference {
    return new RdbInstanceMaintenancesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export interface RdbInstanceUpgradableVersions {
}

export function rdbInstanceUpgradableVersionsToTerraform(struct?: RdbInstanceUpgradableVersions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function rdbInstanceUpgradableVersionsToHclTerraform(struct?: RdbInstanceUpgradableVersions): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class RdbInstanceUpgradableVersionsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): RdbInstanceUpgradableVersions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: RdbInstanceUpgradableVersions | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
    }
    else {
...
export class RdbInstanceUpgradableVersionsList extends cdktf.ComplexList {
  ...
  * @param index the index of the item to return
  */
  public get(index: number): RdbInstanceUpgradableVersionsOutputReference {
    return new RdbInstanceUpgradableVersionsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export interface RdbInstanceLogsPolicy {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/rdb_instance#max_age_retention RdbInstance#max_age_retention}
  */
  readonly maxAgeRetention?: number;
  /**
  * The max disk size of remote logs to keep on the Database Instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/rdb_instance#total_disk_retention RdbInstance#total_disk_retention}
  */
...
export interface RdbInstanceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/rdb_instance#create RdbInstance#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/rdb_instance#default RdbInstance#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/rdb_instance#delete RdbInstance#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/rdb_instance#read RdbInstance#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/rdb_instance#update RdbInstance#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/rdb_instance scaleway_rdb_instance}
*/
export class RdbInstance extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RdbInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/rdb_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/resources/rdb_instance scaleway_rdb_instance} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _maintenances = new RdbInstanceMaintenancesList(this, "maintenances", false);
  ...
  private _upgradableVersions = new RdbInstanceUpgradableVersionsList(this, "upgradable_versions", false);
