// https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_budget
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_budget scaleway_billing_budget}
*/
export class DataScalewayBillingBudget extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayBillingBudget that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_budget#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.80.0/docs/data-sources/billing_budget scaleway_billing_budget} Data Source
  *
  * @param scope The scope in which to define this construct
