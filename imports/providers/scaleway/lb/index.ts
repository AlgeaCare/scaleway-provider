// https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb
...
export interface LbConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#assign_flexible_ip Lb#assign_flexible_ip}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#assign_flexible_ipv6 Lb#assign_flexible_ipv6}
  */
  readonly assignFlexibleIpv6?: boolean | cdktf.IResolvable;
  /**
  * The description of the lb
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#description Lb#description}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#external_private_networks Lb#external_private_networks}
  */
  readonly externalPrivateNetworks?: boolean | cdktf.IResolvable;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#id Lb#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#ip_id Lb#ip_id}
  */
  readonly ipId?: string;
  /**
  * List of IP IDs to attach to the Load Balancer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#ip_ids Lb#ip_ids}
  */
  readonly ipIds?: string[];
  /**
  * Name of the lb
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#name Lb#name}
  */
  readonly name?: string;
  /**
  * The project_id you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#project_id Lb#project_id}
  */
  readonly projectId?: string;
  /**
  * Release the IPs related to this load-balancer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#release_ip Lb#release_ip}
  */
  readonly releaseIp?: boolean | cdktf.IResolvable;
  /**
  * Enforces minimal SSL version (in SSL/TLS offloading context)
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#ssl_compatibility_level Lb#ssl_compatibility_level}
  */
  readonly sslCompatibilityLevel?: string;
  /**
  * Array of tags to associate with the load-balancer
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#tags Lb#tags}
  */
  readonly tags?: string[];
  /**
  * The type of load-balancer you want to create
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#type Lb#type}
  */
  readonly type: string;
  /**
  * The zone you want to attach the resource to
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#zone Lb#zone}
  */
  readonly zone?: string;
  /**
  * private_network block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#private_network Lb#private_network}
  */
  readonly privateNetwork?: LbPrivateNetwork[] | cdktf.IResolvable;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#timeouts Lb#timeouts}
  */
  readonly timeouts?: LbTimeouts;
}
export interface LbPrivateIps {
}

export function lbPrivateIpsToTerraform(struct?: LbPrivateIps): any {
...
export function lbPrivateIpsToHclTerraform(struct?: LbPrivateIps): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class LbPrivateIpsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): LbPrivateIps | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: LbPrivateIps | undefined) {
    if (value === undefined) {
...
export class LbPrivateIpsList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): LbPrivateIpsOutputReference {
    return new LbPrivateIpsOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export interface LbTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#create Lb#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#default Lb#default}
  */
  readonly default?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#delete Lb#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#read Lb#read}
  */
  readonly read?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#update Lb#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb scaleway_lb}
*/
export class Lb extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Lb that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.82.0/docs/resources/lb scaleway_lb} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: LbConfig) {
    ...
    this._externalPrivateNetworks = config.externalPrivateNetworks;
    this._id = config.id;
  ...
  // external_private_networks - computed: false, optional: true, required: false
  private _externalPrivateNetworks?: boolean | cdktf.IResolvable; 
  public get externalPrivateNetworks() {
    return this.getBooleanAttribute('external_private_networks');
  }
  public set externalPrivateNetworks(value: boolean | cdktf.IResolvable) {
    this._externalPrivateNetworks = value;
  }
  public resetExternalPrivateNetworks() {
    this._externalPrivateNetworks = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get externalPrivateNetworksInput() {
    return this._externalPrivateNetworks;
  }
  ...
  private _privateIps = new LbPrivateIpsList(this, "private_ips", false);
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      external_private_networks: cdktf.booleanToTerraform(this._externalPrivateNetworks),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      external_private_networks: {
        value: cdktf.booleanToHclTerraform(this._externalPrivateNetworks),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
